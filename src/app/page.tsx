    ...
    <>
      <Parallax ref={parallaxRef} pages={1.5}>
        <ParallaxLayer offset={0} speed={0.5}>
          <section className="grid md:grid-rows-[10px_1fr_10px] items-center justify-items-center min-h-screen">
            <div className="flex flex-col md:flex-row md:gap-[32px] md:row-start-2">
              <AltCutoutAnimation />
              <p className="md:h-[200px] font-[Crimson_Text] text-8xl flex items-center justify-center">
                ARKIB
              </p>
            </div>
          </section>
